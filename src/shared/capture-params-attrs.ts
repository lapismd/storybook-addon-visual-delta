...
export const VISUAL_DELTA_IGNORE_ATTR_LIST = "data-visual-delta-ignore-selectors";
export const VISUAL_DELTA_CROP_ATTR = "data-visual-delta-crop-to-viewport";
export const VISUAL_DELTA_DIFF_THRESHOLD_ATTR =
  "data-visual-delta-diff-threshold";
export const VISUAL_DELTA_INCLUDE_AA_ATTR =
  "data-visual-delta-diff-include-aa";
