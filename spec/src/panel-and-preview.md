...
| ID        | Requirement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| VD-UI-001 | The panel MUST present coverage, comparison outcome, review status, skip eligibility, and run state as separate concepts. A control MUST mutate only the concept it names. Panel coverage and preview comparison MUST resolve the same exact selected environment: a displayed selected-environment baseline MUST NOT be labelled missing or offer Create, and an environment without a matching baseline MUST NOT retain another environment's overlay. When an eligible missing target becomes ready, the panel MUST expose its exact create action when the backend permits writes.                                                                                                                                                                                                             |
