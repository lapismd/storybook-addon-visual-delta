...
| `VD-API-001`, `VD-API-002`, `VD-API-003`, `VD-API-004`, `VD-API-005`, `VD-API-006`, `VD-API-007`         | `package.json`, `src/node/cli.ts`, `src/node/init-scaffold.ts`, `src/constants.ts`, `src/node/middleware.ts`, `src/preview/capture-params.ts`, `src/node/run-hub.ts`                                                                                                          | `src/node/init-scaffold.spec.ts`, `src/constants.spec.ts`, `src/node/run-hub.spec.ts`, `src/preview/render-lifecycle.spec.ts`, package dry-run, and host middleware tests                                                                                                        | Conforming                              |
...
| `VD-GOV-001`, `VD-GOV-002`, `VD-GOV-003`, `VD-GOV-004`, `VD-GOV-005`, `VD-GOV-006`, `VD-GOV-007`, `VD-GOV-008` | `spec/book.toml`, `AGENTS.md`, root `package.json`, `pnpm-lock.yaml`, `scripts/check-spec-structure.mjs`, `scripts/check-spec-first.mjs`, `.github/workflows/visual-delta-spec-first.yml`, `.github/workflows/visual-delta-ci.yml` | `scripts/check-spec-structure.spec.mjs`, `scripts/check-spec-first.spec.mjs`, mdBook build, Markdown lint, `pnpm audit`, aggregate-check wiring, and path-filtered package/panel/host visual CI | Conforming                              |
