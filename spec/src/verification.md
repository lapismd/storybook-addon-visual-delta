...
| `VD-API-001`, `VD-API-002`, `VD-API-003`, `VD-API-004`, `VD-API-005`, `VD-API-006`, `VD-API-007`, `VD-API-008` | `package.json`, `scripts/check-npm-release.mjs`, `src/node/cli.ts`, `src/node/init-scaffold.ts`, `src/constants.ts`, `src/node/middleware.ts`, `src/preview/capture-params.ts`, `src/node/run-hub.ts`                                                                          | `scripts/check-npm-release.spec.mjs`, `src/node/portable-host.spec.ts`, `src/node/init-scaffold.spec.ts`, `src/constants.spec.ts`, `src/node/run-hub.spec.ts`, `src/node/playwright-results.spec.ts`, `src/preview/render-lifecycle.spec.ts`, package dry-run, and host middleware tests | Conforming                              |
