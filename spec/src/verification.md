...
| `VD-UI-001`, `VD-UI-002`, `VD-UI-003`, `VD-UI-004`, `VD-UI-005`, `VD-UI-006`, `VD-UI-007`               | `src/panel/Panel.tsx`, `src/panel/PanelView.tsx`, `src/preview/overlay.ts`, `src/panel/usePlaySteps.ts`, `src/manager/run-visual.ts`                                                            | Panel component tests, compare-view keyboard tests, `src/preview/render-lifecycle.spec.ts`, `src/manager/run-visual-reconnect.spec.ts`, panel browser tests        | Partial: gaps VD-GAP-005 and VD-GAP-006 |
