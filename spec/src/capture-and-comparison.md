...
| ID         | Requirement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| VD-CAP-001 | Authoritative captures MUST use Chromium at a `1280 × 900` CSS viewport, the effective device scale factor from configuration (image entry → story → project → built-in default `1`), light color scheme, `en-GB`, `Europe/London`, reduced motion, hidden caret, and disabled animations.                                                                                                                                                                                                                                                                              |
