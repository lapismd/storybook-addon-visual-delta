...
| VD-CAP-006 | Live HTML comparison MUST remain diagnostic. Exact-story configured-browser and static Playwright comparisons are authoritative and MUST share one outcome classifier. Browser and platform baselines MUST be compared only with captures from the same environment.                                                                                                                                                                                                                                      |
