...
source and built output into isolated staging, mounts it at the link's resolved
container path, and supplies a separate container dependency volume. This keeps
linked development live without importing host-platform `node_modules` into the
canonical Linux profile.
