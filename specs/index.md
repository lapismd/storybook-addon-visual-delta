...
This reference is the source of truth for Visual Delta behavior in this repository. It defines the system boundaries, contracts, invariants, and acceptance criteria that every implementation must satisfy.

## Authority

The files in this directory are normative. Requirement words use the following meanings:
...
Every intentional behavior change MUST update the specification before or with implementation:
