...
- Initial worktree: clean; parent contains the user-reviewed Popover story and
  baseline update.
...
- Visual Delta unit suite: 70 files and 284 tests passing.
...
- Browser regression: Dropdown Menu reports the real 1280x64 versus 1232x64
  ...
  turn it into a pass.
- Panel Playwright: all 36 behavioral tests pass. Eight compare-only panel
